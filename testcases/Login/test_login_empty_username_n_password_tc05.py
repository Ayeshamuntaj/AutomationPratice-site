...
class TestLogin:
    def test_Login(self,driver):
        ...
        login.myaccount_click().username_input("").password_input("").login_button_click()
        assert login.invalid_Emaild_address_error_text()=='Error: Username is required.',"Home page not loaded for Login Signoff TC05 scenario"
        login.close()
